...
public class CashServiceImpl implements CashService {
	...
	/*
	 * @Override public List<Map<String, Object>> findPayMethodsForInvoice(Long
	 * invoiceID) { PaymentMeansForInvoiceFinder paymentMeansForInvoiceFinder = new
	 * PaymentMeansForInvoiceFinder(invoiceID); return
	 * paymentMeansForInvoiceFinder.execute(); }
	 */
