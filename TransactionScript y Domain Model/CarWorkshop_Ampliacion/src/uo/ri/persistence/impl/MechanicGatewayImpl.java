...
public class MechanicGatewayImpl implements MechanicGateway {
	...
	@Override
	public void deleteMechanic(Map<String, Object> map) throws BusinessException {
		try {
			pst = con.prepareStatement(Conf.get("SQL_DELETE_FROM_MECANICOS"));
			pst.setLong(1, (long) map.get("idMecanico"));
			pst.executeUpdate();
		} catch (SQLException e) {
			throw new BusinessException("El mecanico no se puede borrar");
		} finally {
			Jdbc.close(pst);
		}
	...
	@Override
	public void addMechanic(Map<String, Object> map) throws BusinessException {
		try {
			...
			throw new BusinessException("El mecanico no se puede añadir");
		} finally {
			Jdbc.close(pst);
		}
	}
	...
	public List<Map<String, Object>> findAllMechanics() throws BusinessException {
		...
		try {
			...
			throw new BusinessException("No se puede encontrar al mecanico");
		} finally {
			Jdbc.close(rs, pst);
		}
		return list;
	...
	@Override
	public void updateMechanic(Map<String, Object> map) throws BusinessException {
		try {
			...
			throw new BusinessException("El mecanico no se puede actualizar pruebe a borrar y añadir");
		} finally {
			Jdbc.close(pst);
		}
	}
